...
function initStoreLocator(config) {
    ...
    const PRODUCT_CATEGORIES = [
        { id: 'protein-granola',  name: 'Protein Granola',  color: '#D782AC',
          image: CDN + 'ProteinG_AlmondButterBerries_V1_Hero.webp?v=1774023586',
          upcs: new Set(['810589032596','810589032602','810589032619']) },
        { id: 'cookie-granola',   name: 'Cookie Granola',   color: '#75B3E8',
        ...
        { id: 'oatmeal',          name: 'Oatmeal',           color: '#92BDEE',
        ...
        { id: 'protein-oatmeal',  name: 'Protein Oatmeal',  color: '#E8A86E',
        ...
        { id: 'cereal',           name: 'Cereal',            color: '#EBA25C',
          image: CDN + '13oz_AGFlakes_GoldenCinnamonV1_Hero.webp?v=1774372330',
